...
class ModelAccountInvoices extends Model {
	...
	public function getInvoice($invoice_id) {
                ...
                $invoice_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "cycling_invoices` WHERE customer_id = '" . (int)$this->customer->getId() . "'");
		...
		if ($order_query->num_rows) {
			...
			return array(
                                ...
                                'invoice_number'          => $invoice_query->row['invoiceNumber'],
                                'txnid'                   => $invoice_query->row['txnid'],
                                'amount'                  => $invoice_query->row['amount'],
                                'invoice_status_id'       => $invoice_query->row['status_id'],
                                'amount'                  => $invoice_query->row['amount'],
                                'invoice_date_added'      => $invoice_query->row['date_added'],
